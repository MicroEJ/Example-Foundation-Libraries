...
- Make sure the configuration option `core.outputstream.disable.uart` is set to `true`. 
- Make sure the configuration option `core.outputstream.class` is set to `com.microej.example.foundation.microui.out.OutputStreamRedirection`. 
