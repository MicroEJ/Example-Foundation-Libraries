...
`./gradlew :microui.image:runOnSimulator`
...
`./gradlew :microui.image:runOnDevice`

Alternative ways to run on device are described in the [Run on Device](https://docs.microej.com/en/latest/SDK6UserGuide/runOnDevice.html) documentation.

## Expected Behavior

The images stored in [src/main/resources/images](src/main/resources/images) are displayed on the screen.
