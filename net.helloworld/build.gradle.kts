...
tasks.register<GradleBuild>("runOnSimulator-Server") {
    ...
    startParameter.systemPropertiesArgs["applicationMainClass"] = "com.microej.example.foundation.net.helloworld.ExampleServer"
}
...
microej {
    applicationMainClass = "com.microej.example.foundation.net.helloworld.ExampleClient"
